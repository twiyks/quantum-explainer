...
const QUIZ_QUESTIONS = [
  {
    q: "You roll the die 500 times and face 3 comes up 120 times (24%). You reveal the true weights: face 3 is actually 14%. Which of these is the distribution?",
    options: [
      "The 24% you measured — that is what the die actually produced",
      "The 14% hidden inside the die, which your rolls were estimating",
      "The average of 24% and 14%, which is 19%",
      "There is no distribution yet — it only becomes fixed once you have rolled enough"
    ],
    answer: 1,
    feedback: [
      "That is your estimate, built from 500 rolls — not the distribution itself. The die's hidden percentages do not change when you roll it.",
      "Correct. The distribution is the fixed set of numbers inside the die. Your 24% was your estimate of it. The gap between those two things is what this module is about.",
      "Averaging the two does not give either one. The distribution is the hidden truth (14%), not a blend.",
      "The distribution is fixed from the start. Rolling reveals it slowly; it was always there."
    ]
  },
  {
    q: "Your estimate has a typical error of about 4 percentage points, based on 100 rolls. You want to halve that error to about 2 percentage points. How many rolls do you need?",
    options: [
      "200 rolls — twice as many rolls halves the error",
      "50 rolls — you only need half as many",
      "400 rolls — you need four times as many rolls",
      "10,000 rolls — you need a hundred times as many"
    ],
    answer: 2,
    feedback: [
      "The error falls with the square root of the number of rolls, not the number itself. Doubling the rolls only reduces error by a factor of √2, about 1.4.",
      "Fewer rolls means more error, not less.",
      "Correct. The error is proportional to 1 divided by the square root of the rolls. To halve the error, you need four times the rolls: 100 × 4 = 400.",
      "A hundred times the rolls reduces the error by a factor of 10, not 2. Much more than needed here."
    ]
  },
  {
    q: "You roll the die once and it lands on face 5. What can you now say about the distribution?",
    options: [
      "Face 5 is probably the most common face",
      "Face 5 has at least some chance — it cannot be 0%",
      "Very little — one result is an anecdote, not a shape",
      "The distribution must be roughly flat, since any face could have landed"
    ],
    answer: 2,
    feedback: [
      "One outcome tells you almost nothing about frequency. Face 5 landing once is entirely consistent with it being the rarest face.",
      "True but trivial — it does confirm face 5 is not impossible, but tells you nothing about how likely it is relative to the others.",
      "Correct. A single roll is one data point. The distribution is six hidden numbers, and you need many rolls before their shape becomes visible.",
      "One result does not let you draw any conclusions about the shape of the distribution."
    ]
  }
];
