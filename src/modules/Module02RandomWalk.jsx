...
const QUIZ_QUESTIONS = [
  {
    q: "After 10 steps of the random walk, why does the centre position end up with the most walkers?",
    options: [
      "The coin is more likely to land heads after a run of tails, pulling the walker back towards the middle",
      "There is a force of attraction at the centre that slows down walkers who stray too far out",
      "There are more different sequences of ten steps that end in the middle than at the edges",
      "Each step back cancels a step forward, so most walkers end up near where they started by coincidence"
    ],
    answer: 2,
    feedback: [
      "A fair coin has no memory. The chance of heads is always 50%, regardless of what has landed before.",
      "There is no such force. Nothing in the walk depends on where the person currently is.",
      "Correct. To finish 10 steps to the right requires 10 heads in a row — exactly one route. To finish in the middle requires 5 heads and 5 tails in any order, and there are 252 different sequences that do that. The middle fills up because more paths lead there.",
      "This is close but not the right explanation. Steps do partially cancel, but the reason more walkers end up in the middle is not coincidence — it is that vastly more routes lead there."
    ]
  },
  {
    q: "Classically, if two different sequences of coin flips both end at the same position, what happens to the chance of landing there?",
    options: [
      "It stays the same — the paths are alternatives, so only one can count at a time",
      "It goes up — every additional route makes that position more likely",
      "It might go up or down, depending on whether the routes are mirror images of each other",
      "It goes down — more routes create more competition for the same ending"
    ],
    answer: 1,
    feedback: [
      "Classically, paths do not cancel. Each route is a real possibility that adds to the total chance.",
      "Correct. Every additional route to a destination adds to its probability. More ways of getting somewhere always means it is more likely. Module seven will show precisely where this stops being true.",
      "Classical routes are not affected by their shape or direction. Each route counts independently, regardless of what it looks like.",
      "Routes do not compete. The chance of landing somewhere is the total number of routes to it divided by the total number of possible walks."
    ]
  },
  {
    q: "After 100 steps of the random walk, how far from the start is a typical walker?",
    options: [
      "About 100 steps — the person has walked 100 steps so covers the full distance",
      "About 50 steps — roughly half the steps go forward and half go back, leaving the person halfway out",
      "About 10 steps — the typical distance is the square root of the number of steps",
      "Exactly back at the start — forward and back steps cancel each other out on average"
    ],
    answer: 2,
    feedback: [
      "That would only happen if all 100 steps went in the same direction — a single route out of 2¹⁰⁰ possibilities.",
      "About half the steps do go each way on average, but the net displacement is much smaller than 50. Cancel those halves against each other and what is left is the square root, not the half.",
      "Correct. The typical distance grows as the square root of the number of steps. √100 = 10. To get twice as far (20 steps from start), you would need four times as many steps.",
      "The average displacement is zero, but that is not the same as saying the typical walker ends up back at the start. Each individual walk spreads out."
    ]
  }
];
